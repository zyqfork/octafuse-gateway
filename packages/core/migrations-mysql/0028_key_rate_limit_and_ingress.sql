...
ALTER TABLE api_keys ADD COLUMN rate_limit TEXT NULL;
ALTER TABLE users ADD COLUMN rate_limit TEXT NULL;

ALTER TABLE api_key_request_logs ADD COLUMN ingress_host VARCHAR(255) NULL;
